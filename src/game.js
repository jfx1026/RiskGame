 ...
 */
export function startGame(map, teams) {
    return {
        teams,
 ...
 */
export function isOwnedByCurrentTeam(state, territoryId) {
 ...
 */
export function deselectTerritory(state) {
    return {
        ...state,
        selectedTerritory: null,
        phase: 'select',
 ...
 */
export function attemptAttack(state, targetId) {
 ...
 */
export function findLargestContiguousGroup(territories, teamId) {
    ...
    for (const territory of teamTerritories) {
        ...
        while (queue.length > 0) {
            ...
            if (!current || current.owner !== teamId)
                continue;
            groupSize++;
 ...
 */
export function applyResupply(state) {
 ...
 */
export function getSelectedTerritoryTargets(state) {
    if (state.selectedTerritory === null) {
        return [];
    }
    const source = state.territories.find(t => t.id === state.selectedTerritory);
